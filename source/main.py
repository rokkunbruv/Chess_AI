            ...
            for event in pygame.event.get():
                ...
                # if you release mouse left-click
                    ...
                    if dragger.dragging:
                        ...
                        initial = Tile(dragger.initial_row, dragger.initial_col)
                        final = Tile(released_row, released_col)
